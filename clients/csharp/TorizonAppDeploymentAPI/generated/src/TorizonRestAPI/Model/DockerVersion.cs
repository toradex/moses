...
namespace TorizonRestAPI.Model
{
    ...
    public partial class DockerVersion :  IEquatable<DockerVersion>, IValidatableObject
    {
        ...
        public DockerVersion(DockerVersionPlatform platform = default(DockerVersionPlatform), List<DockerVersionComponentsInner> components = default(List<DockerVersionComponentsInner>), string version = default(string), string apiVersion = default(string), string minAPIVersion = default(string), string gitCommit = default(string), string goVersion = default(string), string os = default(string), string arch = default(string), string kernelVersion = default(string), bool experimental = default(bool), string buildTime = default(string))
        {
        ...
        public List<DockerVersionComponentsInner> Components { get; set; }
