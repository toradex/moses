...
namespace TorizonRestAPI.Api
{
    ...
    public interface IApplicationsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task ApplicationBuildAsync (string applicationId, string configuration, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ApplicationDeployAsync (string applicationId, string configuration, string deviceid, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of DockerContainer</returns>
        System.Threading.Tasks.Task<DockerContainer> ApplicationRunAsync (string applicationId, string configuration, string deviceid, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<InlineResponse200> ApplicationRunsdkAsync (string applicationId, string configuration, bool? build = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ApplicationSyncfoldersAsync (string applicationId, string sourcefolder, string configuration, string deviceid, string destfolder, bool? sourceIsSdk = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ApplicationUpdatesdkAsync (string applicationId, string configuration, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ApplicationsApi : IApplicationsApi
    {
        ...
        /// <summary>
        /// Get container log, chunk by chunk Return one chunk of log (one or more lines), blocking if no data is available
        /// </summary>
        /// <exception cref="TorizonRestAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="applicationId">Id of an application (uuid)</param>
        /// <param name="configuration"></param>
        ...
        /// <summary>
        /// Get SDK container Get SDK container for check if it is running
        /// </summary>
        /// <exception cref="TorizonRestAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="applicationId">Id of an application (uuid)</param>
        /// <param name="configuration"></param>
