...
namespace TorizonRestAPI.Api
{
    ...
    public interface IDevicesApi : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeviceSyncfoldersAsync (string deviceId, string sourcefolder, string destfolder, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class DevicesApi : IDevicesApi
    {
        ...
        /// <summary>
        /// return container logs one chunk a time return one or more lines of the log, waiting until it&#39;s available, this will allow clients to show logs in almost real time
        /// </summary>
        /// <exception cref="TorizonRestAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="deviceId">Target device serial number</param>
        /// <param name="containerId">Id of a container</param>
