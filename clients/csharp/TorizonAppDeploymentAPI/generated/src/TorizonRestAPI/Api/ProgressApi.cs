...
namespace TorizonRestAPI.Api
{
    ...
    public partial class ProgressApi : IProgressApi
    {
        ...
        /// <summary>
        /// create a progress ID creates a progress object that could be used to monitor and abort operations
        /// </summary>
        /// <exception cref="TorizonRestAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Progress</returns>
        ...
        /// <summary>
        /// releases progress ID if delete is called when the operation is still pending, it will try to abort it
        /// </summary>
        /// <exception cref="TorizonRestAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="progressId">Id of a progress cookie (uuid) (optional)</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// retrieves status of an operation return status and messages, it&#39;s blocking until status changes or the operation is completed
        /// </summary>
        /// <exception cref="TorizonRestAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="progressId">Id of a progress cookie (uuid) (optional)</param>
        /// <returns>Progress</returns>
