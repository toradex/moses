    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            if ((status < 200) || (status > 299))
            {
                ...
                return new TorizonAppDeploymentAPI.TorizonAPIException(code, description, message);
            }
            return null;
        };
        ...
        public Configuration(
            ...
            string basePath = "http://localhost:5000/api") : this()
        {
        ...
        {
            String report = "C# SDK (TorizonRestAPI) Debug Report:\n";
