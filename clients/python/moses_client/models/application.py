...
class Application(object):
    ...
    def __init__(self, id=None, platformid=None, folder=None, props=None, dockercomposefile=None, startupscript=None, shutdownscript=None, ports=None, volumes=None, devices=None, networks=None, extraparms=None, username=None, local_vars_configuration=None):  # noqa: E501
