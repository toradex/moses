...
class Application(object):
    ...
    attribute_map = {
        ...
        'sdkimages': 'sdkimages',
        'imagetags': 'imagetags',
        'sdkimagetags': 'sdkimagetags'
    }

    def __init__(self, id=None, platformid=None, folder=None, props=None, dockercomposefile=None, startupscript=None, shutdownscript=None, ports=None, volumes=None, devices=None, networks=None, extraparms=None, username=None, images=None, sdkimages=None, imagetags=None, sdkimagetags=None, local_vars_configuration=None):  # noqa: E501
        ...
        if sdkimagetags is not None:
            self.sdkimagetags = sdkimagetags
    ...
    @property
    def imagetags(self):
        """Gets the imagetags of this Application.  # noqa: E501

        unique tag used for the images  # noqa: E501

        :return: The imagetags of this Application.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def imagetags(self, imagetags):
        """Sets the imagetags of this Application.

        unique tag used for the images  # noqa: E501

        :param imagetags: The imagetags of this Application.  # noqa: E501
        :type imagetags: dict(str, str)
        """

        self._imagetags = imagetags

    @property
    def sdkimagetags(self):
        """Gets the sdkimagetags of this Application.  # noqa: E501

        unique tag used for the SDK images (if application uses an SDK)  # noqa: E501

        :return: The sdkimagetags of this Application.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._sdkimagetags

    @sdkimagetags.setter
    def sdkimagetags(self, sdkimagetags):
        """Sets the sdkimagetags of this Application.

        unique tag used for the SDK images (if application uses an SDK)  # noqa: E501

        :param sdkimagetags: The sdkimagetags of this Application.  # noqa: E501
        :type sdkimagetags: dict(str, str)
        """

        self._sdkimagetags = sdkimagetags
