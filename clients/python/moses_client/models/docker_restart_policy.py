...
class DockerRestartPolicy(object):
    ...
    def name(self):
        ...
        - Empty string means not to restart - \"no\" No restart - `always` Always restart - `unless-stopped` Restart always except when the user has manually stopped the container - `on-failure` Restart only when the container exit code is non-zero   # noqa: E501
    ...
    def name(self, name):
        ...
        :type: str
        """
        allowed_values = ["", "no", "always", "unless-stopped", "on-failure"]  # noqa: E501
