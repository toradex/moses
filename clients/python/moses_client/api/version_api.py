...
class VersionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.version_docker_endpoint = _Endpoint(
            settings={
                'response_type': (DockerVersion,),
                'auth': [],
                'endpoint_path': '/version/docker',
                'operation_id': 'version_docker',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def version_docker(
        ...
        **kwargs
        ...
        return self.version_docker_endpoint.call_with_http_info(**kwargs)
