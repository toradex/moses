...
class DevicesApi(object):
    ...
    def container_getlogs(self, device_id, container_id, **kwargs):  # noqa: E501
        """return container logs one row a time  # noqa: E501

        return one row of the log, waiting until it's available, this will allow clients to show logs in almost real time  # noqa: E501
