...
from moses_client import rest
from moses_client.configuration import Configuration
from moses_client.exceptions import ApiTypeError, ApiValueError, ApiException
from moses_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.application_build  # this is an instance of the class Endpoint
        api_instance.application_build()  # this invokes api_instance.application_build.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.application_build.callable or self.callable in this class
