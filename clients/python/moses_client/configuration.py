...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of moses_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = moses_client.Configuration(
    ...
    Note you can use the constants defined in the moses_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = moses_client.Configuration(
        signing_info = moses_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost:5000/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("moses_client")
