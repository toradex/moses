...
class DockerContainerConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'exposed_ports': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),  # noqa: E501
            'tty': (bool,),  # noqa: E501
            ...
            'image': (str,),  # noqa: E501
            'volumes': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            exposed_ports ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): An object mapping ports to an empty object in the form:  `{\"<port>/<tcp|udp|sctp>\": {}}` . [optional]  # noqa: E501
            ...
            volumes ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): An object mapping mount point paths inside the container to empty objects.. [optional]  # noqa: E501
